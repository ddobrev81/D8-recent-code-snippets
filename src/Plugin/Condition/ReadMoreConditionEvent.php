 ...
 *
 * @Condition(
 *   id = "event_read_more_condition",
 *   label = @Translation("Event: Read More Visibility"),
 *   context = {
 ...
 * )
 */
class ReadMoreConditionEvent extends ConditionPluginBase implements ContainerFactoryPluginInterface {
  ...
  public function evaluate() {
    ...
    if ($node = $this->getContextValue('node')) {
      if ($node->hasField('field_event_read_more') && $node->field_event_read_more->value) {
        return TRUE;
      }
    }
    return FALSE;
